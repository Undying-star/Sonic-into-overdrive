...
Serial:		if Revision=0
		dc.b "GM 4202008 -69"   ; Serial/version number (Rev 0)
			...
			dc.b "GM 4202008 -69" ; Serial/version number (Rev non-0)
		endif
Checksum: dc.w $0
		dc.b "J               " ; I/O support
...
Pal_Tails:	binclude 	"palette/Tails.bin"
...
M_Card_LZ:	dc.b 9			; LABYRINTH
		...
		dc.b $F8, 5, 0,	$1C, $34
		even
M_Card_MZ:	dc.b 6	;  MARBLE | BRIDGE
		dc.b $F8, 5, 0, 4, $F4		; B
		dc.b $F8, 5, 0, $3A, $4		; R
		dc.b $F8, 1, 0, $20, $14	; I
		dc.b $F8, 5, 0, $0C, $1C	; D
...
M_Card_SLZ:	dc.b 9			; STAR LIGHT
		...
		dc.b $F8, 5, 0,	$42, $3C
		even
M_Card_SYZ:		dc.b 9	;  SPRING YARD | SPARKLING
		dc.b $F8, 5, 0, $3E, $C4	; S
		dc.b $F8, 5, 0, $36, $D4	; P
		dc.b $F8, 5, 0, 0, $E4		; A
		dc.b $F8, 5, 0, $3A, $F4	; R
