...
Vectors:	dc.l v_systemstack&$FFFFFF	; Initial stack pointer value
		...
		dc.l JmpToCrashRoutine			; Bus error
		dc.l JmpToCrashRoutine		; Address error (4)
		dc.l JmpToCrashRoutine		; Illegal instruction
		dc.l JmpToCrashRoutine			; Division by zero
		dc.l JmpToCrashRoutine			; CHK exception
		dc.l JmpToCrashRoutine			; TRAPV exception (8)
		dc.l JmpToCrashRoutine		; Privilege violation
		dc.l JmpToCrashRoutine				; TRACE exception
		dc.l JmpToCrashRoutine		; Line-A emulator
		dc.l JmpToCrashRoutine		; Line-F emulator (12)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved) (16)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved) (20)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved)
		dc.l JmpToCrashRoutine		; Unused (reserved) (24)
		dc.l JmpToCrashRoutine		; Spurious exception
		dc.l JmpToCrashRoutine			; IRQ level 1
		dc.l JmpToCrashRoutine			; IRQ level 2
		dc.l JmpToCrashRoutine			; IRQ level 3 (28)
		dc.l HBlank				; IRQ level 4 (horizontal retrace interrupt)
		dc.l JmpToCrashRoutine			; IRQ level 5
		dc.l VBlank				; IRQ level 6 (vertical retrace interrupt)
		dc.l JmpToCrashRoutine			; IRQ level 7 (32)
		dc.l JmpToCrashRoutine			; TRAP #00 exception
		dc.l JmpToCrashRoutine			; TRAP #01 exception
		dc.l JmpToCrashRoutine			; TRAP #02 exception
		dc.l JmpToCrashRoutine			; TRAP #03 exception (36)
		dc.l JmpToCrashRoutine			; TRAP #04 exception
		dc.l JmpToCrashRoutine			; TRAP #05 exception
		dc.l JmpToCrashRoutine			; TRAP #06 exception
		dc.l JmpToCrashRoutine			; TRAP #07 exception (40)
		dc.l JmpToCrashRoutine			; TRAP #08 exception
		dc.l JmpToCrashRoutine			; TRAP #09 exception
		dc.l JmpToCrashRoutine			; TRAP #10 exception
		dc.l JmpToCrashRoutine			; TRAP #11 exception (44)
		dc.l JmpToCrashRoutine			; TRAP #12 exception
		dc.l JmpToCrashRoutine			; TRAP #13 exception
		dc.l JmpToCrashRoutine			; TRAP #14 exception
		dc.l JmpToCrashRoutine			; TRAP #15 exception (48)
		dc.l JmpToCrashRoutine			; Unused (reserved)
		dc.l JmpToCrashRoutine			; Unused (reserved)
		dc.l JmpToCrashRoutine			; Unused (reserved)
		dc.l JmpToCrashRoutine			; Unused (reserved)
...
loc_E0:
		...
		dc.w JmpToCrashRoutine
		dc.l JmpToCrashRoutine
		dc.l JmpToCrashRoutine
		dc.l JmpToCrashRoutine
	endif
...
Pal_Crash:	incbin	"palette\Crash.bin"
...
GM_Crash:
		...
		bsr.w	ClearScreen
		locVRAM	0
		lea	(Nem_Crash).l,a0 ; load Sega	logo patterns
		bsr.w	NemDec
		lea	($FF0000).l,a1
		lea	(Eni_Crash).l,a0 ; load Sega	logo mappings
		move.w	#0,d0
		bsr.w	EniDec

		copyTilemap	$FF0000,$C410,$27,$1B

	@loadpal:
                moveq	#palid_Crash,d0
...
Crash_Wait:
		move.b	#2,(v_vbla_routine).w
		bsr.w	WaitForVBla
		move.w	#$200,(v_demolength).w  ; $200 = 10 seconds

Crash_WaitEnd:
		move.b	#2,(v_vbla_routine).w
		bsr.w	WaitForVBla
		tst.w	(v_demolength).w
		beq.s	Crash_GotoTitle
		andi.b	#btnStart,(v_jpadpress1).w ; is Start button pressed?
		beq.s	Crash_WaitEnd	; if not, branch
...
MusicList2:
		...
		include	"_incObj\Tails Display.asm"
...
Nem_JapNames:	incbin	"artnem\Hidden Japanese Credits.bin"
		even
Eni_Crash:	incbin	"tilemaps\Crash.bin"
		even
Nem_Crash:	incbin	"artnem\0x18000.bin"
		even
...
; ---------------------------------------------------------------------------
Art_Tails:	incbin	"artunc\Tails.bin"	; Tails
		even
; ---------------------------------------------------------------------------
...
Blk16_GHZ:	incbin	"map16\GHZ.bin"
		even
Nem_Title8x8:	incbin	"artnem\8x8 - Title.bin"	; GHZ primary patterns
		even
Kos_GHZ:	incbin	"artkos\8x8 - GHZ.bin"	; GHZ secondary patterns
		even
Blk256_GHZ:	incbin	"map256\GHZ.bin"
		even
Blk16_LZ:	incbin	"map16\LZ.bin"
		even
Kos_LZ:		incbin	"artkos\8x8 - LZ.bin"	; LZ primary patterns
		even
